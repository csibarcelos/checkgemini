...
import { Link, useNavigate } from 'react-router-dom'; // Standardized
      ...
      {selectedProduct && (
        <Modal isOpen={isDetailsModalOpen} onClose={handleCloseDetailsModal} title={`Detalhes do Produto: ${selectedProduct.name}`} size="xl">
          <div className="space-y-3 max-h-[75vh] overflow-y-auto pr-2">
            ...
            <InfoItem label="Descrição" value={<div className="text-xs max-h-24 overflow-y-auto bg-neutral-50 p-2 rounded border border-neutral-200">{selectedProduct.description}</div>} />
